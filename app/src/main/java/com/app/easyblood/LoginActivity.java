...
import com.app.easyblood.SignUp.NewSignUpActicity;
...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.easyblood.R.layout.activity_login);

        editTextEmailId = (EditText) findViewById(com.app.easyblood.R.id.editTextLoginEmail);
        editTextPassword = (EditText) findViewById(com.app.easyblood.R.id.editTextLoginPassword);

        final View controlsView = findViewById(com.app.easyblood.R.id.fullscreen_content_controls);
    }
