...
public class SignUpActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.easyblood.R.layout.activity_sign_up);

        editTextFirstName = (EditText) findViewById(com.app.easyblood.R.id.editTextFirstName);
        editTextLastName = (EditText) findViewById(com.app.easyblood.R.id.editTextLastName);
        editTextPhoneNumber = (EditText) findViewById(com.app.easyblood.R.id.editTextPhoneNumber);
        editTextProfession = (EditText) findViewById(com.app.easyblood.R.id.editTextProfession);
        editTextEmailId = (EditText) findViewById(com.app.easyblood.R.id.editTextEmail);
        editTextPassword = (EditText) findViewById(com.app.easyblood.R.id.editTextPassword);
        editTextReEnteredPassword = (EditText) findViewById(com.app.easyblood.R.id.editTextReEnterPassword);
        editTextAddress1 = (EditText) findViewById(com.app.easyblood.R.id.editTextAddress1);
        editTextPinCode1 = (EditText) findViewById(com.app.easyblood.R.id.editTextPinCode1);
        editTextAddress2= (EditText) findViewById(com.app.easyblood.R.id.editTextAddress2);
        editTextPinCode2 = (EditText) findViewById(com.app.easyblood.R.id.editTextPinCode2);

        image = (ImageButton) findViewById(com.app.easyblood.R.id.imageButtonProfilePhoto);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.app.easyblood.R.menu.menu_sign_up, menu);
        return true;
    }
