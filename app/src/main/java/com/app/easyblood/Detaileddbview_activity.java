...
public class Detaileddbview_activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.easyblood.R.layout.detaileddb);
        tvusernamedb=(TextView)findViewById(com.app.easyblood.R.id.tvusernamedb);
        tvquestiondb=(TextView)findViewById(com.app.easyblood.R.id.tvquestiondb);
        tvaskedtimedb=(TextView)findViewById(com.app.easyblood.R.id.tvaskedtimedb);
        tvquestion_iddb=(TextView)findViewById(com.app.easyblood.R.id.tvquestion_iddb);
        answerlistview=(ListView)findViewById(com.app.easyblood.R.id.listViewdbans);
    ...
    public void populateanswerlistfromdb(){
        ...
        simpleCursorAdapter1=new SimpleCursorAdapter(getBaseContext(), com.app.easyblood.R.layout.answer_single,cursor,fromcolumns,tofeilds,0);
