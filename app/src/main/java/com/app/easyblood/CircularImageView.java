...
public class CircularImageView extends ImageView {
    ...
    public CircularImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.app.easyblood.R.styleable.CircularImageView,
                defStyle, 0);

        mMaskDrawable = a.getDrawable(com.app.easyblood.R.styleable.CircularImageView_maskDrawable);
        if (mMaskDrawable != null) {
            mMaskDrawable.setCallback(this);
        }

        mBorderDrawable = a.getDrawable(com.app.easyblood.R.styleable.CircularImageView_borderDrawable);
        if (mBorderDrawable != null) {
            mBorderDrawable.setCallback(this);
        }

        mDesaturateOnPress = a.getBoolean(com.app.easyblood.R.styleable.CircularImageView_desaturateOnPress,
                mDesaturateOnPress);
