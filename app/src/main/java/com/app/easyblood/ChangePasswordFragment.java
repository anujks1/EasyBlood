...
public class ChangePasswordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FrameLayout layout = (FrameLayout) inflater.inflate(com.app.easyblood.R.layout.fragment_change_password, container, false);
        ...
        editTextCurrentPassword = (EditText) layout.findViewById(com.app.easyblood.R.id.editTextCurrentPassword);
        editTextNewPassword = (EditText) layout.findViewById(com.app.easyblood.R.id.editTextNewPassword);
        editTextConfirmPassword = (EditText) layout.findViewById(com.app.easyblood.R.id.editTextConfirmPassword);

        changePassword = (Button) layout.findViewById(com.app.easyblood.R.id.buttonChangePassword);
