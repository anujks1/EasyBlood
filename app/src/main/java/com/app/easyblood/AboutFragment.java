...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FrameLayout layout = (FrameLayout) inflater.inflate(com.app.easyblood.R.layout.fragment_about, container, false);
        ...
        String text = "here.";
        TextView label = (TextView) layout.findViewById(com.app.easyblood.R.id.textViewLink);
        label.setText(text);
