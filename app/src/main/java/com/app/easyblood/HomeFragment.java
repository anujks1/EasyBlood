...
import com.app.easyblood.DBHandlers.QuestionModelDBHandler;
import com.app.easyblood.DBHandlers.RequestsDBHandler;
import com.app.easyblood.models.CategoryList;
import com.app.easyblood.models.Question_Model;
import com.app.easyblood.models.Requests;
import com.app.easyblood.Requests.MyRequests;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FrameLayout layout = (FrameLayout) inflater.inflate(com.app.easyblood.R.layout.fragment_home, container, false);

        activity = (FragmentActivity) super.getActivity();

        TextView userName = (TextView) layout.findViewById(com.app.easyblood.R.id.homeUserName);
        userName.setText(TempDataClass.userName);

        profilePhoto = (ImageView) layout.findViewById(com.app.easyblood.R.id.imageViewProfilePhoto);
        ...
        buttonNewRequest = (Button) layout.findViewById(com.app.easyblood.R.id.buttonNewRequest);
        buttonNewQuestion = (Button) layout.findViewById(com.app.easyblood.R.id.buttonNewQuestion);
    ...
    public void generatenewquestion(){
        ...
        final View promptview = factory.inflate(
                com.app.easyblood.R.layout.ask_question_dialogue, null);
        final AlertDialog alertDialog = new AlertDialog.Builder(getActivity()).create();
        alertDialog.setView(promptview);
        alertDialog.setMessage("Ask a new Question!");
        final EditText etquestion=(EditText)promptview.findViewById(com.app.easyblood.R.id.etquestion_ask_question);
        final AutoCompleteTextView etcategory=(AutoCompleteTextView)promptview.findViewById(com.app.easyblood.R.id.etcategory_ask_question);
        ...
        promptview.findViewById(com.app.easyblood.R.id.ask_button).setOnClickListener(new View.OnClickListener() {
        ...
        promptview.findViewById(com.app.easyblood.R.id.cancel_button).setOnClickListener(new View.OnClickListener() {
    ...
    public void GenerateNewRequest() {
        ...
        View promptsView = li.inflate(com.app.easyblood.R.layout.alert_prompt_new_request, null);
        ...
        final EditText requestEditText = (EditText) promptsView.findViewById(com.app.easyblood.R.id.editTextDialogUserInput);
        //mAdapter = new ArrayAdapter<String>(getActivity().getApplicationContext(), R.layout.spinner_item, array);
        //spinner1.setAdapter(mAdapter);

        final Switch locationSwitch = (Switch) promptsView.findViewById(com.app.easyblood.R.id.switch1);
    ...
    private class HttpAsyncTaskPOST extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Fragment currentFragment = getActivity().getSupportFragmentManager().findFragmentById(com.app.easyblood.R.id.container);

            FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
            //TempDataClass.fragmentStack.lastElement().onPause();
            TempDataClass.fragmentStack.push(currentFragment);
            fragmentManager.beginTransaction()
                    .replace(com.app.easyblood.R.id.container, nextFragment)
                    .commit();
        }
    }
    ...
    public class ask_question_async extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            ft.replace(com.app.easyblood.R.id.container, TempDataClass.fragmentStack.lastElement());
