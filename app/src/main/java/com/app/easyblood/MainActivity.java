...
import com.app.easyblood.Chat.PreviousChatFragment;
import com.app.easyblood.DBHandlers.DeviceInfoDBHandler;
import com.app.easyblood.models.DeviceInfoKeys;
import com.app.easyblood.questions.QuestionsFeed;
import com.app.easyblood.DBHandlers.UserModelDBHandler;
import com.app.easyblood.Requests.MyRequests;
import com.app.easyblood.Requests.RequestDisplayActivity;
import com.app.easyblood.Requests.RequestsDisplayActivity;
import com.app.easyblood.Responses.ResponseDisplayActivity;
import com.app.easyblood.models.UserModel;
import com.app.easyblood.questions.MyQuestions;
import com.app.easyblood.questions.SavedForOfflineReading;
...
public class MainActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.easyblood.R.layout.activity_main);
        ...
        mNavigationDrawerFragment = (NavigationDrawerFragment)
                getSupportFragmentManager().findFragmentById(com.app.easyblood.R.id.navigation_drawer);
        mTitle = getTitle();

        // Set up the drawer.
        mNavigationDrawerFragment.setUp(
                com.app.easyblood.R.id.navigation_drawer,
                (DrawerLayout) findViewById(com.app.easyblood.R.id.drawer_layout));
    ...
    private void replaceFragment(){
        ...
        fragmentManager.beginTransaction()
                .replace(com.app.easyblood.R.id.container, initialFragment)
                .commit();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(com.app.easyblood.R.menu.main, menu);
            restoreActionBar();
            return true;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.app.easyblood.R.id.action_settings) {
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(com.app.easyblood.R.layout.fragment_main, container, false);
            return rootView;
        }
    ...
    public void UpdateFragment(View v){
        ...
        fragmentManager.beginTransaction()
                .replace(com.app.easyblood.R.id.container, temp)
                .commit();
    ...
    public void NavigatetoOfflineQuestions(View v){
        Fragment currentFragment = getSupportFragmentManager().findFragmentById(com.app.easyblood.R.id.container);
