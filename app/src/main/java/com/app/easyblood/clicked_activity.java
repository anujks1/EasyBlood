...
public class clicked_activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.easyblood.R.layout.activity_clicked_activity);
        tvusername=(TextView)findViewById(com.app.easyblood.R.id.tvusername);
        addtodbbtn=(Button)findViewById(com.app.easyblood.R.id.readlater);
        tvquestion=(TextView)findViewById(com.app.easyblood.R.id.tvquestion);
        tvaskedtime=(TextView)findViewById(com.app.easyblood.R.id.tvaskedtime);
        tvquestion_id1=(TextView)findViewById(com.app.easyblood.R.id.tvquestion_id1);

        imageView=(ImageView)findViewById(com.app.easyblood.R.id.imageView);
        l = (ListView) findViewById(com.app.easyblood.R.id.listView2);
    ...
    public class answerfeed extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if (aBoolean == false) {
                ...
                Answer_Adapter answer_adapter1 = new Answer_Adapter(getApplicationContext(), com.app.easyblood.R.layout.answer_single, answerlist);
