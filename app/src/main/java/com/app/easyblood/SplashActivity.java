...
public class SplashActivity extends Activity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.easyblood.R.layout.activity_splash);

        context = getApplicationContext();

        mDisplay = (TextView) findViewById(com.app.easyblood.R.id.textViewRegId);
...
/*                    DeleteRequestsOnTheServer delete = new DeleteRequestsOnTheServer();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.app.easyblood.R.menu.menu_splash, menu);
        return true;
    }
