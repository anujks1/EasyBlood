...
public class UpdateUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FrameLayout layout = (FrameLayout) inflater.inflate(com.app.easyblood.R.layout.fragment_update_user, container, false);
        ...
        textViewEmailId = (TextView) layout.findViewById(com.app.easyblood.R.id.textVIewUpdateEmailId);

        editTextFirstName = (EditText) layout.findViewById(com.app.easyblood.R.id.editTextUpdateFirstName);
        editTextLastName = (EditText) layout.findViewById(com.app.easyblood.R.id.editTextUpdateLastName);
        editTextPhoneNumber = (EditText) layout.findViewById(com.app.easyblood.R.id.editTextUpdatePhoneNumber);

        updateUser = (Button) layout.findViewById(com.app.easyblood.R.id.buttonUpdate);
