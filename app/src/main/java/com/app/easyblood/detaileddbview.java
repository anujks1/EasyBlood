...
public class detaileddbview extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout relativeLayout=(RelativeLayout)inflater.inflate(com.app.easyblood.R.layout.detaileddb,container,false);
        tvusernamedb=(TextView)relativeLayout.findViewById(com.app.easyblood.R.id.tvusernamedb);
        tvquestiondb=(TextView)relativeLayout.findViewById(com.app.easyblood.R.id.tvquestiondb);
        tvaskedtimedb=(TextView)relativeLayout.findViewById(com.app.easyblood.R.id.tvaskedtimedb);
        tvquestion_iddb=(TextView)relativeLayout.findViewById(com.app.easyblood.R.id.tvquestion_iddb);
        answerlistview=(ListView)relativeLayout.findViewById(com.app.easyblood.R.id.listViewdbans);
    ...
    public void populateanswerlistfromdb(){
        ...
        int[] tofeilds=new int[]{com.app.easyblood.R.id.tvansweredby, com.app.easyblood.R.id.tvansweredtime, com.app.easyblood.R.id.tvanswerid, com.app.easyblood.R.id.tvrealanswer};
        SimpleCursorAdapter simpleCursorAdapter1;
        simpleCursorAdapter1=new SimpleCursorAdapter(getActivity(), com.app.easyblood.R.layout.answer_single,cursor,fromcolumns,tofeilds,0);
   ...
   public void openandqueryanswerdb(){
    ...
    public void diplayanswerlistdb(){
        Answer_Adapter myansweradapter = new Answer_Adapter(getActivity(), com.app.easyblood.R.layout.answer_single, answerlistdb);
        answerlistview.setAdapter(myansweradapter);
        myansweradapter.notifyDataSetChanged();
